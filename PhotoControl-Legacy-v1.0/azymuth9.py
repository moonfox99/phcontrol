...
class TitlePageTemplateDialog(QDialog):
    ...
    def __init__(self, parent=None, mode='create', template_data=None):
        ...
        self.setStyleSheet("""
            ...
            QGroupBox[objectName="signature_group"] {
                border: 2px solid #6c757d;
                background-color: #f8f9fa;
            }
            QGroupBox[objectName="signature_group"]::title {
                color: #495057;
                font-weight: 700;
                background-color: #f8f9fa;
            }
    ...
    def create_control_panel(self, parent):
        ...
        control_widget.setStyleSheet("""
            ...
            QLabel {
                background: none;
                border: none;
                color: #343a40;  /* Темно-сірий замість чорного */
            }
            /* НОВІ СУЧАСНІ СТИЛІ КНОПОК */
            QPushButton {
                background-color: #f8f9fa;
                border: 1px solid #dee2e6;
                border-radius: 6px;
            ...
            /* СПЕЦІАЛЬНИЙ СТИЛЬ ДЛЯ ГОЛОВНОЇ КНОПКИ */
