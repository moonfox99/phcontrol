...
def create_title_page(doc, title_data):
    ...
    try:
        ...
        unit_info = title_data.get('unit_info', 'А0000')
        commander_info = title_data.get('commander_info', DefaultTemplateData.get_default_commander_info())
        chief_of_staff_info = title_data.get('chief_of_staff_info', DefaultTemplateData.get_default_responsible_info()['responsible'])
